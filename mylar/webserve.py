...
#----
        ...
        config = {
                    ...
                    "pack_priority": helpers.checked(mylar.CONFIG.PACK_PRIORITY),
                    "autosearch_ended": helpers.checked(mylar.CONFIG.AUTOSEARCH_ENDED),
                    "notify_group_packs": helpers.checked(mylar.CONFIG.NOTIFY_GROUP_PACKS),
                    "notify_pack_gif": helpers.checked(mylar.CONFIG.NOTIFY_PACK_GIF),
...
#--- works, just need to redo search.py to accomodate multiple search terms
    ...
    def configUpdate(self, **kwargs):
        checked_configs = ['enable_https', 'launch_browser', 'backup_on_start', 'keep_html_cache', 'syno_fix', 'auto_update', 'annuals_on', 'api_enabled', 'nzb_startup_search',
                           ...
                           'packs_default', 'pack_priority', 'autosearch_ended', 'notify_group_packs', 'notify_pack_gif',
